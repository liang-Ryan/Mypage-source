...
export const useNoteStore = defineStore('NoteStore', () => {
  ...
  // 结构说明：
  //    以 数组 / 对象 （vue均判断为object）作为判断单元
  //    具备key的元素由Paragraph处理为一级/二级标题
  //    不具备key的元素由Tables组件处理，进行2层 数组 / 对象 的遍历，第二层数组的元素作为单元格内容
  //    单元格内容由Cell组件处理，进行正文内容(字符串)或表格(数组/对象)的判断。正文内容直接渲染，表格内容再次调用Tables组件进行解析
  //
  //    分类名: {
  //      一级标题: [ // Paragraph组件处理
  //        '正文内容',
  ...
  //          [ // 表格最外层数组 // Table组件处理
  //            [单元格内容,单元格内容] // 表格行
  //            [单元格内容,单元格内容] // 表格行由Table组件处理，单元格内容由Cell组件处理判断
  //            [单元格内容,[          // 单元格嵌套表格，嵌套表格最外层
  //              [单元格内容,单元格内容] // 嵌套表格行（单元格可多层嵌套表格）
  //            ],'正文内容']
  //          ]
  //        ]
  //      ]
